...
parser.add_argument('--gt_path', type=str, default='./data/davis/Annotations/480p', help='ground truth seg path')
parser.add_argument('--pred_path', type=str, default='./data/svcnet/Annotations', help='generated image seg path')
...
fn_list = './data/list/svcnet/val.lst'
...
for im_p in list_f.readlines():
    ...
    relative_name = im_p.split('Annotations/480p/')[-1].strip()
    print(relative_name)
