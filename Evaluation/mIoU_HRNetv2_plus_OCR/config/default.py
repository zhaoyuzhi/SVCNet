...
_C.DATASET.NUM_STUFF = 11
_C.DATASET.NUM_THINGS = 8
...
_C.TRAIN.SEMATIC_ONLY = False
_C.TRAIN.SHOW_IMAGE = False

_C.TRAIN.FREEZE_LAYERS = ''
_C.TRAIN.FREEZE_EPOCHS = -1
_C.TRAIN.NONBACKBONE_KEYWORDS = []
_C.TRAIN.NONBACKBONE_MULT = 10
_C.TRAIN.SLOWBACKBONE_KEYWORDS = []
_C.TRAIN.SLOWBACKBONE_MULT = 1e-4
