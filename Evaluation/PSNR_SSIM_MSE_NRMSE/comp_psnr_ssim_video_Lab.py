...
if __name__ == "__main__":
    ...
    parser.add_argument('--base_root', type = str, \
        default = 'F:\\submitted papers\\SVCNet\\SVCNet comparison_DAVIS_videvo\\2dataset_RGB', \
            help = 'base_root')
    parser.add_argument('--generated_root', type = str, \
        default = 'F:\\submitted papers\\SVCNet\\SVCNet comparison_DAVIS_videvo\\VCGAN_first_stage', \
            help = 'generated_root')
