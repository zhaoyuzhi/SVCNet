...
if __name__ == "__main__":
    ...
    parser.add_argument('--cpnet_path', type = str, default = '../trained_models/CPNet/models_2nd_vimeo_256p/CPNet_VGG16_Seg/cpnet_epoch10_batchsize16.pth', help = 'the load name of models')
    ...
    parser.add_argument('--lr_g_ssnet', type = float, default = 2e-5, help = 'Adam: learning rate')
    ...
    parser.add_argument('--lambda_reg', type = float, default = 0, help = 'coefficient for Regularization Loss')
    ...
    # Dataset parameters
    parser.add_argument('--baseroot', type = str, default = '/media/zyz/DATADRIVE1/dataset/vimeo_septuplet/sequences', help = 'the base training folder')
    parser.add_argument('--segroot', type = str, default = '/media/zyz/DATADRIVE1/dataset/vimeo_septuplet/sequences', help = 'the base training folder')
    parser.add_argument('--video_class_txt', type = str, default = './txt/sep_trainlist.txt', help = 'the path that contains DAVIS_videvo_train_class.txt')
    parser.add_argument('--video_imagelist_txt', type = str, default = './txt/sep_trainlist.txt', help = 'the path that contains DAVIS_videvo_train_imagelist.txt')
